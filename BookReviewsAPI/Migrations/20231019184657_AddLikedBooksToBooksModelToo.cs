...
{
    /// <inheritdoc />
    public partial class AddLikedBooksToBooksModelToo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookUser", x => new { x.LikedBooksId, x.LikedByUsersId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_BookUser_Users_LikedByUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookUser_LikedByUsersId",
                table: "BookUser",
